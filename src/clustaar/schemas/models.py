...
# Flow connection
Choice = model("Choice", "image_url title session_values callback_action")
Section = model("Section", "title choices callback_action")
SendChoicesListAction = model("SendChoicesListAction", "message sections callback_action")
